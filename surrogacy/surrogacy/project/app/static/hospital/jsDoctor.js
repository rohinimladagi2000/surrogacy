...
$(document).ready(function () {
  ...
  $(document).on("click", "#btn_update", function () {
    ...
    $.ajax({
      ...
      contentType: false,
      success: function (result) {
        alert("Doctor Details Updated Succesfully");
        location.reload();
        table.ajax.reload();
